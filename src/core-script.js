    ...
    init: () => {
      ...
      $(function () {
        ...
        var input_html = `
          ...
          #address5669, #next5669, #sectionA5562, #sectionB5562, #sectionC5562 {
      ...
      `;
        ...
        $$("#xlsxfile").change(function () {
          ...
          reader.onloadend = function (evt) {
            ...
            datas = XLSX.utils.sheet_to_json(
              workbook.Sheets[sheet_name_list[0]],
              { header: 1 }
            );
            $$("#texta").append(datas);
            var addDepPart = XLSX.utils.sheet_to_json(
              workbook.Sheets[sheet_name_list[1]],
              { header: 1 }
            );
            depNum = addDepPart[11][1];
            form0008 = XLSX.utils.sheet_to_json(
            ...
            depPersonalDetailIndices = findIndicesOfValue(
              form0008,
              "Dep Personal details"
            );
            console.log("depPersonalDetailIndices" + depPersonalDetailIndices);
            depEduIndices = findIndicesOfValue(
              form0008,
              "Dep Education/occupation detail"
            );
            depLanguageIndices = findIndicesOfValue(
              form0008,
              "Dep Language detail"
            );
            depPassportIndices = findIndicesOfValue(form0008, "Dep Passport");
            depNationalIDIndices = findIndicesOfValue(
              form0008,
              "Dep National identity document"
            );
            form5406 = XLSX.utils.sheet_to_json(
              workbook.Sheets[sheet_name_list[3]],
              { header: 1 }
            );
            sectionAIndices = findIndicesOfValue(form5406, "Section A");
            sectionBIndices = findIndicesOfValue(
              form5406,
              "Section B： Children"
            );
            sectionCIndices = findIndicesOfValue(form5406, "Section C: Siblings");
            form5562 = XLSX.utils.sheet_to_json(
              workbook.Sheets[sheet_name_list[5]],
              { header: 1 }
            );
            sectionAIndices5562 = findIndicesOfValue(
              form5562,
              "Section A: Principal applicant (yourself)"
            );
            sectionBIndices5562 = findIndicesOfValue(
              form5562,
              "Section B: Your spouse or common-law partner"
            );
            sectionCIndices5562 = findIndicesOfValue(
              form5562,
              "Section C: Your dependant children 18 years or older"
            );
            form5669 = XLSX.utils.sheet_to_json(
              workbook.Sheets[sheet_name_list[4]],
              { header: 1 }
            );
            personalDetailIndices = findIndicesOfValue(
              form5669,
              "Personal Detail"
            );
            ...
            membershipIndices = findIndicesOfValue(
              form5669,
              "Membership and association with organizations"
            );
            govermentIndices = findIndicesOfValue(
              form5669,
              "Government positions"
            );
            militaryIndices = findIndicesOfValue(
              form5669,
        ...
        function settingProfile() {
          ...
          var preferredLanguage = document.querySelectorAll(
            'select[id = "profileForm-correspondence"]'
          )[0];
        ...
        function settingProfileResAdd() {
          ...
          const resAptUnit = document.querySelectorAll(
            'input[id="apartmentUnit"]'
          )[1];
          const resStrNum = document.querySelectorAll(
            'input[id="streetNumber"]'
          )[1];
          const resStrName = document.querySelectorAll(
            'input[id="streetName"]'
          )[1];
          ...
          const resProvince = document.querySelectorAll(
            'input[id="province"]'
          )[1];
          const resPostalcode = document.querySelectorAll(
            'input[id="postalCode"]'
          )[1];
          const resDistrict = document.querySelectorAll(
            'input[id="district"]'
          )[1];
        ...
        $$("#start").click(function () {
          ...
          var signInButton = document.querySelector(
        ...
        function fillDependent(sheet2) {
          ...
          const yesInput = document.querySelector(
            ".form-radio__option#dependantYes"
          );
          const noInput = document.querySelector(
            ".form-radio__option#dependantNo"
          );
          ...
          var program_dropdown = document.querySelectorAll(
            'select[id = "dependantForm-relationship"]'
          )[0];
          ...
          const depFName = document.querySelector(
            'input[id="dependantForm-familyName"]'
          );
          const depGName = document.querySelector(
            'input[id="dependantForm-givenName"]'
          );
          const dob = document.querySelectorAll(
            'input[id="personalDetailsForm-dob"]'
          )[1];
          ...
          const saveDetails = document.querySelector(
        ...
        function fill0008() {
          ...
          interview.selectedIndex = 88;
          interview.dispatchEvent(changeEvent);
          const interpreter = document.querySelector(
            'select[id="interpreterRequested"]'
          );
          interpreter.selectedIndex = 1;
        ...
        async function personalDetails0008(row, col) {
          ...
          const yesNickName = document.querySelector(
            "#personalDetailsForm-usedOtherName-yes"
          );
          const noNickName = document.querySelector(
            "#personalDetailsForm-usedOtherName-no"
          );
          if (hasNickName === "Yes") {
            yesNickName.checked = true;
            yesNickName.dispatchEvent(new Event("change", { bubbles: true }));
            await delay(500);
            var nickFName = document.querySelector(
              "#personalDetailsForm-otherFamilyName"
            );
            var nickGName = document.querySelector(
              "#personalDetailsForm-otherGivenName"
            );
        ...
        async function personalDetails0008afterUCI(row, col) {
          var form0008 = XLSX.utils.sheet_to_json(
            workbook.Sheets[sheet_name_list[2]],
            { header: 1 }
          );
          var cellRow = row;
          ...
          var placeOfBirth = document.querySelector(
            "#personalDetailsForm-cityOfBirth"
          );
          imitateKeyInput(placeOfBirth, form0008[++cellRow][col]);
          var countryOfBirth = document.querySelector(
            "#personalDetailsForm-countryOfBirth"
          );
          countryOfBirth.selectedIndex = 49;
          countryOfBirth.dispatchEvent(new Event("change", { bubbles: true }));
          var citiCountry = document.querySelector(
            "#personalDetailsForm-citizenship1"
          );
          citiCountry.selectedIndex = 37;
          citiCountry.dispatchEvent(new Event("change", { bubbles: true }));
          var resCountry = document.querySelector(
            "#personalDetailsForm-currentCountry"
          );
          cellRow += 3;
          ...
          var status = document.querySelector(
            "#personalDetailsForm-immigrationStatus"
          );
          ...
          if (statusForm === 3 || statusForm === 4 || statusForm === 5) {
            await delay(150);
            var resStatuFrom = document.querySelector(
              "#personalDetailsForm-startDateofImmigrationStatus"
            );
            cellCol = col;
            imitateKeyInput(resStatuFrom, form0008[cellRow][++cellCol]);
            var resStatuTo = document.querySelector(
              "#personalDetailsForm-endDateOfImmigrationStatus"
            );
            imitateKeyInput(resStatuTo, form0008[cellRow][++cellCol]);
            var dateOfLastEntry = document.querySelector(
              "#personalDetailsForm-dateOfLastEntry"
            );
            imitateKeyInput(dateOfLastEntry, form0008[cellRow][++cellCol]);
            var placeOfLastEntry = document.querySelector(
              "#personalDetailsForm-placeOfLastEntry"
            );
            imitateKeyInput(placeOfLastEntry, form0008[cellRow][++cellCol]);
          }
          const yesMore5 = document.querySelector(
            "#personalDetailsForm-hasPreviousCountries-yes"
          );
          const noMore5 = document.querySelector(
            "#personalDetailsForm-hasPreviousCountries-no"
          );
          cellRow = cellRow + 1;
          ...
          if (more5 === "Yes") {
            ...
            while (form0008[cellRow][++cellCol] != undefined) {
              ...
              const prevCountry = document.querySelector(
                "#personalDetailsForm-prevCountry" + preCountryIte
              );
              prevCountry.selectedIndex = form0008[cellRow][cellCol];
              prevCountry.dispatchEvent(new Event("change", { bubbles: true }));
              const prevImmigrationStatus = document.querySelector(
                "#personalDetailsForm-prevImmigrationStatus" + preCountryIte
              );
              prevImmigrationStatus.selectedIndex = form0008[cellRow][++cellCol];
              prevImmigrationStatus.dispatchEvent(
                new Event("change", { bubbles: true })
              );
              const prevStartDateImmigrationStatus = document.querySelector(
                "#personalDetailsForm-prevStartDateOfImmigrationStatus" +
                  preCountryIte
              );
              imitateKeyInput(
                prevStartDateImmigrationStatus,
                form0008[cellRow][++cellCol]
              );
  
              const prevEndDateImmigrationStatus = document.querySelector(
                "#personalDetailsForm-prevEndDateOfImmigrationStatus" +
                  preCountryIte
              );
              imitateKeyInput(
                prevEndDateImmigrationStatus,
                form0008[cellRow][++cellCol]
              );
              if (form0008[cellRow][cellCol + 1] != undefined) {
                document
                  .querySelector('button[category = "primary"][type="button"]')
                  .click();
              }
              preCountryIte++;
            }
          ...
          const martial = document.querySelector(
          ...
          if (martialStatu === 2 || martialStatu === 4) {
            await delay(500);
            const marriedDate = document.querySelector(
              "#personalDetailsForm-dateOfMarriageOrCommonLaw"
            );
            const spouseFname = document.querySelector(
              "#personalDetailsForm-familyNameOfSpouse"
            );
            const spouseGname = document.querySelector(
              "#personalDetailsForm-givenNameOfSpouse"
            );
        ...
        async function personalDetails0008afterCurrentMartal(row, col) {
          ...
          const yesPreRela = document.querySelector(
            "#personalDetailsForm-previouslyMarriedOrCommonLaw-yes"
          );
          const noPreRela = document.querySelector(
            "#personalDetailsForm-previouslyMarriedOrCommonLaw-no"
          );
          ...
          if (preRela === "Yes") {
            ...
            await delay(500);
            var spouseFName = document.querySelector(
              "#previousRelationshipForm-previousSpouseFamilyName"
            );
            var spouseGName = document.querySelector(
              "#previousRelationshipForm-previousSpouseGivenName"
            );
            var spouseDOB = document.querySelector(
              "#previousRelationshipForm-previousSpouseDob"
            );
            var spouseRela = document.querySelector(
              "#previousRelationshipForm-typeOfRelationship"
            );
            var startDateRela = document.querySelector(
              "#previousRelationshipForm-startDateofRelationship"
            );
            var endDateRela = document.querySelector(
              "#previousRelationshipForm-endDateOfRelationship"
            );
        ...
        $$("#contact0008").click(function () {
          ...
          const AlternateCountryCode = document.querySelector(
        ...
        async function nationalID(row, col) {
          ...
          await delay(100);
          const nationalIdentityNumber = document.querySelector(
        ...
        $$("#nationalID").click(function () {
          ...
          window.setTimeout(() => {
            ...
            IDcountryOfIssue.selectedIndex = 37;
            IDcountryOfIssue.dispatchEvent(
              new Event("change", { bubbles: true })
            );
        ...
        function education0008(row, col) {
          ...
          const intendedOccupation = document.querySelector(
            "#intendedOccupation"
          );
        ...
        $$("#dep0008-1").click(async function () {
          ...
          console.log(
            "form0008[cellRowDep0008][3]" + form0008[cellRowDep0008][3]
          );
          if (form0008[cellRowDep0008][3] === "No") {
            var accompReason = document.querySelector(
              'input[id="dependantDetailsForm-reasonNotAccompanying"]'
            );
          ...
          if (form0008[++cellRowDep0008][3] != undefined) {
            var depType = document.querySelector(
              'select[id="dependantDetailsForm-dependantType"]'
            );
          ...
          await personalDetails0008(
            depPersonalDetailIndices[form0008_counter].rowIndex + 1,
            4
          );
        });
        ...
        $$("#next0008").click(function () {
          ...
          $("#texta").val(
            "0008 person " + form0008_counter + " " + form0008[1 + base][0]
          );
        });
        ...
        $$("#nextDependant").click(function () {
          ...
          $("#texta").val(
            "5406 person" + form5406_counter + " " + form5406[1 + base][0]
          );
        ...
        $$("#sectionA5406").click(async function () {
          ...
          if (form5406_counter <= depNum) {
            ...
            const country = document.querySelector(
              '.form-input__field[name="applicantBirthplace"]'
            );
            imitateKeyInput(
              country,
              form5406[2 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            const email = document.querySelector(
              '.form-input__field[name="applicantEmail"]'
            );
            imitateKeyInput(
              email,
              form5406[4 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            const address = document.querySelector(
              '.form-textarea__field[name="applicantAddress"]'
            );
            imitateKeyInput(
              address,
              form5406[5 + sectionAIndices[form5406_counter].rowIndex][3]
            );
  
            var martial = document.querySelector(
              'select[id="applicantMaritalStatus"]'
            );
            console.log("martial", martial);
  
            martial.selectedIndex =
              form5406[3 + sectionAIndices[form5406_counter].rowIndex][3];
            martial.dispatchEvent(changeEvent);
  
            // Spouse
            const partner_fullname = document.querySelector(
              '.form-input__field[name="partnerFullName"]'
            );
            imitateKeyInput(
              partner_fullname,
              form5406[7 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            await delay(500);
            const partnerDOB = document.querySelector(
              '.form-datepicker__field[name="partnerDOB"]'
            );
            imitateKeyInput(
              partnerDOB,
              form5406[8 + sectionAIndices[form5406_counter].rowIndex][3]
            );
  
            const p_country = document.querySelector(
              '.form-input__field[name="partnerBirthplace"]'
            );
            imitateKeyInput(
              p_country,
              form5406[9 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            const p_email = document.querySelector(
              '.form-input__field[name="partnerEmail"]'
            );
            imitateKeyInput(
              p_email,
              form5406[11 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            const p_address = document.querySelector(
              '.form-textarea__field[name="partnerAddress"]'
            );
            imitateKeyInput(
              p_address,
              form5406[12 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            var p_martial = document.querySelector(
              'select[id="partnerMaritalStatus"]'
            );
            p_martial.selectedIndex =
              form5406[10 + sectionAIndices[form5406_counter].rowIndex][3];
            p_martial.dispatchEvent(changeEvent);
  
            // Mother
            const mother_fullname = document.querySelector(
              '.form-input__field[name="motherFullName"]'
            );
            imitateKeyInput(
              mother_fullname,
              form5406[14 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            await delay(500);
            const motherDOB = document.querySelector(
              '.form-datepicker__field[name="motherDOB"]'
            );
            imitateKeyInput(
              motherDOB,
              form5406[15 + sectionAIndices[form5406_counter].rowIndex][3]
            );
  
            const m_country = document.querySelector(
              '.form-input__field[name="motherBirthplace"]'
            );
            imitateKeyInput(
              m_country,
              form5406[16 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            const m_email = document.querySelector(
              '.form-input__field[name="motherEmail"]'
            );
            imitateKeyInput(
              m_email,
              form5406[18 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            const m_address = document.querySelector(
              '.form-textarea__field[name="motherAddress"]'
            );
            imitateKeyInput(
              m_address,
              form5406[19 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            var m_martial = document.querySelector(
              'select[id="motherMaritalStatus"]'
            );
            m_martial.selectedIndex =
              form5406[17 + sectionAIndices[form5406_counter].rowIndex][3];
            m_martial.dispatchEvent(changeEvent);
  
            // Father
            const father_fullname = document.querySelector(
              '.form-input__field[name="fatherFullName"]'
            );
            imitateKeyInput(
              father_fullname,
              form5406[21 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            await delay(500);
            const fatherDOB = document.querySelector(
              '.form-datepicker__field[name="fatherDOB"]'
            );
            imitateKeyInput(
              fatherDOB,
              form5406[22 + sectionAIndices[form5406_counter].rowIndex][3]
            );
  
            const f_country = document.querySelector(
              '.form-input__field[name="fatherBirthplace"]'
            );
            imitateKeyInput(
              f_country,
              form5406[23 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            const f_email = document.querySelector(
              '.form-input__field[name="fatherEmail"]'
            );
            imitateKeyInput(
              f_email,
              form5406[25 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            const f_address = document.querySelector(
              '.form-textarea__field[name="fatherAddress"]'
            );
            imitateKeyInput(
              f_address,
              form5406[26 + sectionAIndices[form5406_counter].rowIndex][3]
            );
            var f_martial = document.querySelector(
              'select[id="fatherMaritalStatus"]'
            );
            f_martial.selectedIndex =
              form5406[24 + sectionAIndices[form5406_counter].rowIndex][3];
        ...
        $$("#sectionB5406").click(async function () {
          ...
          var form5406 = XLSX.utils.sheet_to_json(
            workbook.Sheets[sheet_name_list[3]],
            { header: 1 }
          );
          const c_no =
            form5406[27 + sectionAIndices[form5406_counter].rowIndex][3];
          //             var child_DOB;
          //             var relationship;
          //             var child_fullname;
          //             var c_martial;
          ...
          if (child_ind < c_no && form5406_counter <= depNum) {
            var relationship = document.querySelector(
              '.form-input__field[name="relationship' + child_ind + '"]'
            );
            imitateKeyInput(
              relationship,
              form5406[
                29 + child_ind * 8 + sectionAIndices[form5406_counter].rowIndex
              ][3]
            );
            var child_fullname = document.querySelector(
              '.form-input__field[name="fullName' + child_ind + '"]'
            );
            imitateKeyInput(
              child_fullname,
              form5406[
                30 + child_ind * 8 + sectionAIndices[form5406_counter].rowIndex
              ][3]
            );
  
            await delay(500);
            var child_DOB = document.querySelector(
              'input[name="dob' + child_ind + '"]'
            );
            console.log("child_DOB", 'input[name="dob' + child_ind + '"]');
            imitateKeyInput(
              child_DOB,
              form5406[
                31 + child_ind * 8 + sectionAIndices[form5406_counter].rowIndex
              ][3]
            );
  
            var c_country = document.querySelector(
              '.form-input__field[name="countryOfBirth' + child_ind + '"]'
            );
            imitateKeyInput(
              c_country,
              form5406[
                32 + child_ind * 8 + sectionAIndices[form5406_counter].rowIndex
              ][3]
            );
            var c_email = document.querySelector(
              '.form-input__field[name="emailAddress' + child_ind + '"]'
            );
            imitateKeyInput(
              c_email,
              form5406[
                34 + child_ind * 8 + sectionAIndices[form5406_counter].rowIndex
              ][3]
            );
            var c_address = document.querySelector(
              '.form-textarea__field[name="address' + child_ind + '"]'
            );
            imitateKeyInput(
              c_address,
              form5406[
                35 + child_ind * 8 + sectionAIndices[form5406_counter].rowIndex
              ][3]
            );
            var c_martial = document.querySelector(
              'select[id="maritalStatus' + child_ind + '"]'
            );
            c_martial.selectedIndex =
              form5406[
                33 + child_ind * 8 + sectionAIndices[form5406_counter].rowIndex
              ][3];
        ...
        $$("#sectionC5406").click(async function () {
          ...
          if (sibing_ind < s_no && form5406_counter <= depNum) {
            relationship = document.querySelector(
              '.form-input__field[name="relationship' + sibing_ind + '"]'
            );
            console.log(
              "sectionCIndices[form5406_counter]",
              sectionCIndices[form5406_counter]
            );
            imitateKeyInput(
              relationship,
              form5406[
                sectionCIndices[form5406_counter].rowIndex + 2 + sibing_ind * 8
              ][3]
            );
            sibing_fullname = document.querySelector(
              '.form-input__field[name="fullName' + sibing_ind + '"]'
            );
            imitateKeyInput(
              sibing_fullname,
              form5406[
                sectionCIndices[form5406_counter].rowIndex + 3 + sibing_ind * 8
              ][3]
            );
  
            await delay(500);
            sibing_DOB = document.querySelector(
              'input[name="dob' + sibing_ind + '"]'
            );
            console.log(
              "sibing_DOB",
              form5406[
                sectionCIndices[form5406_counter].rowIndex + 4 + sibing_ind * 8
              ][3]
            );
            imitateKeyInput(
              sibing_DOB,
            ...
            s_country = document.querySelector(
              '.form-input__field[name="countryOfBirth' + sibing_ind + '"]'
            );
            imitateKeyInput(
              s_country,
              form5406[
                sectionCIndices[form5406_counter].rowIndex + 5 + sibing_ind * 8
              ][3]
            );
            s_email = document.querySelector(
              '.form-input__field[name="emailAddress' + sibing_ind + '"]'
            );
            imitateKeyInput(
              s_email,
              form5406[
                sectionCIndices[form5406_counter].rowIndex + 7 + sibing_ind * 8
              ][3]
            );
            s_address = document.querySelector(
              '.form-textarea__field[name="address' + sibing_ind + '"]'
            );
            imitateKeyInput(
              s_address,
              form5406[
                sectionCIndices[form5406_counter].rowIndex + 8 + sibing_ind * 8
              ][3]
            );
            s_martial = document.querySelector(
              'select[id="maritalStatus' + sibing_ind + '"]'
            );
            s_martial.selectedIndex =
              form5406[
                sectionCIndices[form5406_counter].rowIndex + 6 + sibing_ind * 8
              ][3];
        ...
        $$("#sectionA5562").click(async function () {
          var n_trip =
            form5562[4 + sectionAIndices5562[form5562_counter].rowIndex][4];
          ...
          if (form5562_counter < depNum && trp_ind < n_trip) {
            ...
            if (name_counter < 1) {
              const familyName = document.querySelector(
                '.form-input__field[name="familyName"]'
              );
              console.log("row index:", sectionAIndices5562[form5562_counter]);
              imitateKeyInput(
                familyName,
                form5562[2 + sectionAIndices5562[form5562_counter].rowIndex][3]
              );
              const givenName = document.querySelector(
                '.form-input__field[name="givenName"]'
              );
              imitateKeyInput(
                givenName,
                form5562[3 + sectionAIndices5562[form5562_counter].rowIndex][3]
              );
              var data =
                form5562[3 + sectionAIndices5562[form5562_counter].rowIndex][2];
              const yesInput = document.querySelector(
                '.checkbox__input[name="haveNotTravelled"]'
              );
              if (data === "Yes") {
                // Select "yes" option
                yesInput.checked = true;
            ...
            await delay(500);
            var from_date = document.querySelector(
              'input[name="trip-from-' + trp_ind + '"]'
            );
            console.log("from_date", 'input[name="trip-from-' + trp_ind + '"]');
            imitateKeyInput(
              from_date,
              form5562[
                sectionAIndices5562[form5562_counter].rowIndex + 6 + trp_ind * 6
              ][3]
            );
  
            await delay(500);
            var to_date = document.querySelector(
              'input[name="trip-to-' + trp_ind + '"]'
            );
            console.log("to_date", 'input[name="trip-to-' + trp_ind + '"]');
            imitateKeyInput(
              to_date,
              form5562[
                sectionAIndices5562[form5562_counter].rowIndex + 7 + trp_ind * 6
              ][3]
            );
  
            var destination = document.querySelector(
              'input[name="trip-destination-' + trp_ind + '"]'
            );
            console.log(
              "destination",
              'input[name="trip-destination-' + trp_ind + '"]'
            ...
            imitateKeyInput(
              destination,
              form5562[
                sectionAIndices5562[form5562_counter].rowIndex + 8 + trp_ind * 6
              ][3]
            );
  
            var length = document.querySelector(
              'input[name="trip-length-' + trp_ind + '"]'
            );
            console.log("length", 'input[name="trip-length-' + trp_ind + '"]');
            imitateKeyInput(
              length,
              form5562[
                sectionAIndices5562[form5562_counter].rowIndex + 9 + trp_ind * 6
              ][3]
            );
  
            var purpose = document.querySelector(
              'input[name="trip-purpose-' + trp_ind + '"]'
            );
            console.log("purpose", 'input[name="trip-purpose-' + trp_ind + '"]');
            imitateKeyInput(
              purpose,
              form5562[
                sectionAIndices5562[form5562_counter].rowIndex + 10 + trp_ind * 6
              ][3]
            );
        ...
        $$("#sectionB5562").click(async function () {
          var data =
            form5562[1 + sectionBIndices5562[form5562_counter].rowIndex][2];
          var n_trip =
            form5562[1 + sectionBIndices5562[form5562_counter].rowIndex][4];
          console.log("5562", form5562);
          await delay(200);
          const yesInput = document.querySelector(
            '.checkbox__input[name="haveNotTravelled"]'
          ...
          if (form5562_counter < depNum && trpB_ind < n_trip) {
            var from_date = document.querySelector(
              'input[name="trip-from-' + trpB_ind + '"]'
            );
            console.log("from_date", 'input[name="trip-from-' + trpB_ind + '"]');
            imitateKeyInput(
              from_date,
              form5562[
                sectionBIndices5562[form5562_counter].rowIndex + 3 + trpB_ind * 6
              ][3]
            );
  
            await delay(500);
            var to_date = document.querySelector(
              'input[name="trip-to-' + trpB_ind + '"]'
            );
            console.log("to_date", 'input[name="trip-to-' + trpB_ind + '"]');
            imitateKeyInput(
              to_date,
              form5562[
                sectionBIndices5562[form5562_counter].rowIndex + 4 + trpB_ind * 6
              ][3]
            );
  
            var destination = document.querySelector(
              'input[name="sectionB-destination-' + trpB_ind + '"]'
            );
            console.log(
              "destination",
              'input[name="trip-destination-' + trpB_ind + '"]'
            );
            imitateKeyInput(
              destination,
              form5562[
                sectionBIndices5562[form5562_counter].rowIndex + 5 + trpB_ind * 6
              ][3]
            );
  
            var length = document.querySelector(
              'input[name="trip-length-' + trpB_ind + '"]'
            );
            console.log("length", 'input[name="trip-length-' + trpB_ind + '"]');
            imitateKeyInput(
              length,
              form5562[
                sectionBIndices5562[form5562_counter].rowIndex + 6 + trpB_ind * 6
              ][3]
            );
  
            var purpose = document.querySelector(
              'input[name="trip-purpose-' + trpB_ind + '"]'
            );
            console.log("purpose", 'input[name="trip-purpose-' + trpB_ind + '"]');
            imitateKeyInput(
              purpose,
              form5562[
                sectionBIndices5562[form5562_counter].rowIndex + 7 + trpB_ind * 6
              ][3]
            );
        ...
        $$("#sectionC5562").click(async function () {
          var data =
            form5562[1 + sectionCIndices5562[form5562_counter].rowIndex][2];
          var n_trip =
            form5562[1 + sectionCIndices5562[form5562_counter].rowIndex][4];
          console.log("5562", form5562);
          await delay(200);
          const yesInput = document.querySelector(
            '.checkbox__input[name="haveNotTravelled"]'
          ...
          if (form5562_counter < depNum && trpC_ind < n_trip) {
            const givenName = document.querySelector(
              'input[name="trip-givenName-' + trpC_ind + '"]'
            );
            imitateKeyInput(
              givenName,
              form5562[3 + sectionCIndices5562[form5562_counter].rowIndex][3]
            );
  
            await delay(500);
            var from_date = document.querySelector(
              'input[name="trip-from-' + trpC_ind + '"]'
            );
            console.log("from_date", 'input[name="trip-from-' + trpC_ind + '"]');
            imitateKeyInput(
              from_date,
              form5562[
                sectionCIndices5562[form5562_counter].rowIndex + 4 + trpC_ind * 7
              ][3]
            );
  
            await delay(500);
            var to_date = document.querySelector(
              'input[name="trip-to-' + trpC_ind + '"]'
            );
            console.log("to_date", 'input[name="trip-to-' + trpC_ind + '"]');
            imitateKeyInput(
              to_date,
              form5562[
                sectionCIndices5562[form5562_counter].rowIndex + 5 + trpC_ind * 7
              ][3]
            );
  
            var destination = document.querySelector(
              'input[name="sectionC-destination-' + trpC_ind + '"]'
            );
            console.log(
              "destination",
              'input[name="sectionC-destination-' + trpC_ind + '"]'
            ...
            imitateKeyInput(
              destination,
              form5562[
                sectionCIndices5562[form5562_counter].rowIndex + 6 + trpC_ind * 7
              ][3]
            );
  
            var length = document.querySelector(
              'input[name="trip-length-' + trpC_ind + '"]'
            );
            console.log("length", 'input[name="trip-length-' + trpC_ind + '"]');
            imitateKeyInput(
              length,
              form5562[
                sectionCIndices5562[form5562_counter].rowIndex + 7 + trpC_ind * 7
              ][3]
            );
  
            var purpose = document.querySelector(
              'input[name="trip-purpose-' + trpC_ind + '"]'
            );
            console.log("purpose", 'input[name="trip-purpose-' + trpC_ind + '"]');
            imitateKeyInput(
              purpose,
              form5562[
                sectionCIndices5562[form5562_counter].rowIndex + 8 + trpC_ind * 7
              ][3]
            );
        ...
        function personalDetails5669() {
          ...
          var sectionAFormFatherDOB = document.querySelector(
            "#sectionAFormFatherDOB"
          );
          imitateKeyInput(sectionAFormFatherDOB, form5669[6 + base][4]);
          var sectionAFormFatherDeceasedDate = document.querySelector(
            "#sectionAFormFatherDeceasedDate"
          );
          imitateKeyInput(sectionAFormFatherDeceasedDate, form5669[7 + base][4]);
          var sectionAFormFatherCityOfBirth = document.querySelector(
            "#sectionAFormFatherCityOfBirth"
          );
          imitateKeyInput(sectionAFormFatherCityOfBirth, form5669[8 + base][4]);
          var sectionAFormFatherCountryOfBirth = document.querySelector(
            "#sectionAFormFatherCountryOfBirth"
          );
          imitateKeyInput(
            sectionAFormFatherCountryOfBirth,
            form5669[9 + base][4]
          ...
          var sectionAFormMotherDOB = document.querySelector(
            "#sectionAFormMotherDOB"
          );
          imitateKeyInput(sectionAFormMotherDOB, form5669[13 + base][4]);
          var sectionAFormMotherDeceasedDate = document.querySelector(
            "#sectionAFormMotherDeceasedDate"
          );
          imitateKeyInput(sectionAFormMotherDeceasedDate, form5669[14 + base][4]);
          var sectionAFormMotherCityOfBirth = document.querySelector(
            "#sectionAFormMotherCityOfBirth"
          );
          imitateKeyInput(sectionAFormMotherCityOfBirth, form5669[15 + base][4]);
          var sectionAFormMotherCountryOfBirth = document.querySelector(
            "#sectionAFormMotherCountryOfBirth"
          );
          imitateKeyInput(
            sectionAFormMotherCountryOfBirth,
            form5669[16 + base][4]
        ...
        function quesitonaire(col) {
          ...
          var isConvictedInCanada_yes = document.querySelector(
            "#isConvictedInCanada_yes"
          );
          var isConvictedInCanada_no = document.querySelector(
            "#isConvictedInCanada_no"
          );
          ...
          var isConvictedOutsideCanada_yes = document.querySelector(
            "#isConvictedOutsideCanada_yes"
          );
          var isConvictedOutsideCanada_no = document.querySelector(
            "#isConvictedOutsideCanada_no"
          );
          var isConvictedOutsideCanada = form5669[2 + base][col];
          ifHelper(
            isConvictedOutsideCanada_yes,
            isConvictedOutsideCanada_no,
            isConvictedOutsideCanada
          );
  
          var isClaimedRefugeeProtection_yes = document.querySelector(
            "#isClaimedRefugeeProtection_yes"
          );
          var isClaimedRefugeeProtection_no = document.querySelector(
            "#isClaimedRefugeeProtection_no"
          );
          var isClaimedRefugeeProtection = form5669[3 + base][col];
          ifHelper(
            isClaimedRefugeeProtection_yes,
            isClaimedRefugeeProtection_no,
            isClaimedRefugeeProtection
          );
  
          var isRefusedRefugeeOrVisa_yes = document.querySelector(
            "#isRefusedRefugeeOrVisa_yes"
          );
          var isRefusedRefugeeOrVisa_no = document.querySelector(
            "#isRefusedRefugeeOrVisa_no"
          );
          var isRefusedRefugeeOrVisa = form5669[4 + base][col];
          ifHelper(
            isRefusedRefugeeOrVisa_yes,
            isRefusedRefugeeOrVisa_no,
            isRefusedRefugeeOrVisa
          );
  
          var isOrderedToLeaveCountry_yes = document.querySelector(
            "#isOrderedToLeaveCountry_yes"
          );
          var isOrderedToLeaveCountry_no = document.querySelector(
            "#isOrderedToLeaveCountry_no"
          );
          var isOrderedToLeaveCountry = form5669[5 + base][col];
          ifHelper(
            isOrderedToLeaveCountry_yes,
            isOrderedToLeaveCountry_no,
            isOrderedToLeaveCountry
          );
          ...
          var isCommittedActOfViolence_yes = document.querySelector(
            "#isCommittedActOfViolence_yes"
          );
          var isCommittedActOfViolence_no = document.querySelector(
            "#isCommittedActOfViolence_no"
          );
          var isCommittedActOfViolence = form5669[7 + base][col];
          ifHelper(
            isCommittedActOfViolence_yes,
            isCommittedActOfViolence_no,
            isCommittedActOfViolence
          );
  
          var isAssociatedWithViolentGroup_yes = document.querySelector(
            "#isAssociatedWithViolentGroup_yes"
          );
          var isAssociatedWithViolentGroup_no = document.querySelector(
            "#isAssociatedWithViolentGroup_no"
          );
          var isAssociatedWithViolentGroup = form5669[8 + base][col];
          ifHelper(
            isAssociatedWithViolentGroup_yes,
            isAssociatedWithViolentGroup_no,
            isAssociatedWithViolentGroup
          );
  
          var isMemberOfCriminalOrg_yes = document.querySelector(
            "#isMemberOfCriminalOrg_yes"
          );
          var isMemberOfCriminalOrg_no = document.querySelector(
            "#isMemberOfCriminalOrg_no"
          );
          var isMemberOfCriminalOrg = form5669[9 + base][col];
          ifHelper(
            isMemberOfCriminalOrg_yes,
            isMemberOfCriminalOrg_no,
            isMemberOfCriminalOrg
          );
  
          var isDetainedOrJailed_yes = document.querySelector(
            "#isDetainedOrJailed_yes"
          );
          var isDetainedOrJailed_no = document.querySelector(
            "#isDetainedOrJailed_no"
          );
          ...
          var isPhysicalOrMentalDisorder_yes = document.querySelector(
            "#isPhysicalOrMentalDisorder_yes"
          );
          var isPhysicalOrMentalDisorder_no = document.querySelector(
            "#isPhysicalOrMentalDisorder_no"
          );
          var isPhysicalOrMentalDisorder = form5669[11 + base][col];
          ifHelper(
            isPhysicalOrMentalDisorder_yes,
            isPhysicalOrMentalDisorder_no,
            isPhysicalOrMentalDisorder
          );
        ...
        function education() {
          ...
          var elementarySchoolYears = document.querySelector(
            "#elementarySchoolYears"
          );
          imitateKeyInput(elementarySchoolYears, form5669[2 + base][4]);
          var secondarySchoolYears = document.querySelector(
            "#secondarySchoolYears"
          );
          imitateKeyInput(secondarySchoolYears, form5669[3 + base][4]);
          var universityAndCollegeYears = document.querySelector(
            "#universityAndCollegeYears"
          );
        ...
        function edu_add() {
          ...
          var nameOfInstitution0 = document.querySelector(
            "#nameOfInstitution" + eduIteTime
          );
          imitateKeyInput(
            nameOfInstitution0,
            form5669[9 + base + eduIteTime * 6][5]
          );
          var cityAndCountry0 = document.querySelector(
            "#cityAndCountry" + eduIteTime
          );
          imitateKeyInput(
            cityAndCountry0,
            form5669[10 + base + eduIteTime * 6][5]
          );
          var typeOfDiploma0 = document.querySelector(
            "#typeOfDiploma" + eduIteTime
          );
          imitateKeyInput(
            typeOfDiploma0,
            form5669[11 + base + eduIteTime * 6][5]
          );
          var fieldOfStudy0 = document.querySelector(
            "#fieldOfStudy" + eduIteTime
          );
        ...
        function persHist5669() {
          ...
          imitateKeyInput(
            from0,
            form5669[2 + persHistBase5669 + persHistIteTime * 6][4]
          );
          var to0 = document.querySelector("#to" + persHistIteTime);
          imitateKeyInput(
            to0,
            form5669[3 + persHistBase5669 + persHistIteTime * 6][4]
          );
          var activity0 = document.querySelector("#activity" + persHistIteTime);
          imitateKeyInput(
            activity0,
            form5669[4 + persHistBase5669 + persHistIteTime * 6][4]
          );
          var cityAndCountry0 = document.querySelector(
            "#cityAndCountry" + persHistIteTime
          );
          imitateKeyInput(
            cityAndCountry0,
            form5669[5 + persHistBase5669 + persHistIteTime * 6][4]
          );
          var status0 = document.querySelector("#status" + persHistIteTime);
          imitateKeyInput(
            status0,
            form5669[6 + persHistBase5669 + persHistIteTime * 6][4]
          );
          var nameOfEmployerOrSchool0 = document.querySelector(
            "#nameOfEmployerOrSchool" + persHistIteTime
          );
          imitateKeyInput(
            nameOfEmployerOrSchool0,
            form5669[7 + persHistBase5669 + persHistIteTime * 6][4]
          );
          persHistIteTime++;
        ...
        function membership5669() {
          console.log(
            "membershipIteTime >= form5669[1+membershipbase5669][3]:" +
              membershipIteTime +
              " " +
              form5669[1 + membershipbase5669][3]
          );
          ...
          imitateKeyInput(
            from0,
            form5669[2 + membershipbase5669 + membershipIteTime * 6][4]
          );
          var to0 = document.querySelector("#to" + membershipIteTime);
          imitateKeyInput(
            to0,
            form5669[3 + membershipbase5669 + membershipIteTime * 6][4]
          );
          var nameOfOrganization0 = document.querySelector(
            "#nameOfOrganization" + membershipIteTime
          );
          imitateKeyInput(
            nameOfOrganization0,
            form5669[4 + membershipbase5669 + membershipIteTime * 6][4]
          );
          var typeOfOrganization0 = document.querySelector(
            "#typeOfOrganization" + membershipIteTime
          );
          imitateKeyInput(
            typeOfOrganization0,
            form5669[5 + membershipbase5669 + membershipIteTime * 6][4]
          );
          var activities0 = document.querySelector(
            "#activities" + membershipIteTime
          );
          imitateKeyInput(
            activities0,
            form5669[6 + membershipbase5669 + membershipIteTime * 6][4]
          );
          var cityAndCountry0 = document.querySelector(
            "#cityAndCountry" + membershipIteTime
          );
          imitateKeyInput(
            cityAndCountry0,
            form5669[7 + membershipbase5669 + membershipIteTime * 6][4]
          );
          membershipIteTime++;
        }
        ...
        function govPosition5669() {
          ...
          var dateFrom0 = document.querySelector(
            "#dateFrom" + govPositionIteTime
          );
          imitateKeyInput(
            dateFrom0,
            form5669[2 + govPositionbase5669 + govPositionIteTime * 5][4]
          );
          var to0 = document.querySelector("#to" + govPositionIteTime);
          imitateKeyInput(
            to0,
            form5669[3 + govPositionbase5669 + govPositionIteTime * 5][4]
          );
          var cityAndCountry0 = document.querySelector(
            "#cityAndCountry" + govPositionIteTime
          );
          imitateKeyInput(
            cityAndCountry0,
            form5669[4 + govPositionbase5669 + govPositionIteTime * 5][4]
          );
          var department0 = document.querySelector(
            "#department" + govPositionIteTime
          );
          imitateKeyInput(
            department0,
            form5669[5 + govPositionbase5669 + govPositionIteTime * 5][4]
          );
          var activities0 = document.querySelector(
            "#activities" + govPositionIteTime
          );
          imitateKeyInput(
            activities0,
            form5669[6 + govPositionbase5669 + govPositionIteTime * 5][4]
          );
          govPositionIteTime++;
        }
        ...
        function military5669() {
          ...
          imitateKeyInput(
            country0,
            form5669[2 + militarybase5669 + militaryIteTime * 7][4]
          );
          var branchOfService0 = document.querySelector(
            "#branchOfService" + militaryIteTime
          );
          imitateKeyInput(
            branchOfService0,
            form5669[3 + militarybase5669 + militaryIteTime * 7][4]
          );
          var from0 = document.querySelector("#from" + militaryIteTime);
          imitateKeyInput(
            from0,
            form5669[4 + militarybase5669 + militaryIteTime * 7][4]
          );
          var to0 = document.querySelector("#to" + militaryIteTime);
          imitateKeyInput(
            to0,
            form5669[5 + militarybase5669 + militaryIteTime * 7][4]
          );
          var rank0 = document.querySelector("#rank" + militaryIteTime);
          imitateKeyInput(
            rank0,
            form5669[6 + militarybase5669 + militaryIteTime * 7][4]
          );
          var reasonsEndService0 = document.querySelector(
            "#reasonsEndService" + militaryIteTime
          );
          imitateKeyInput(
            reasonsEndService0,
            form5669[6 + militarybase5669 + militaryIteTime * 7][4]
          );
          var combatDetails0 = document.querySelector(
            "#combatDetails" + militaryIteTime
          );
          imitateKeyInput(
            combatDetails0,
            form5669[6 + militarybase5669 + militaryIteTime * 7][4]
        ...
        function address5669() {
          ...
          imitateKeyInput(
            from0,
            form5669[2 + addressbase5669 + addressIteTime * 7][4]
          );
          var to0 = document.querySelector("#to" + addressIteTime);
          imitateKeyInput(
            to0,
            form5669[3 + addressbase5669 + addressIteTime * 7][4]
          );
          var street = document.querySelector("#street" + addressIteTime);
          imitateKeyInput(
            street,
            form5669[4 + addressbase5669 + addressIteTime * 7][4]
          );
          var city = document.querySelector("#city" + addressIteTime);
          imitateKeyInput(
            city,
            form5669[5 + addressbase5669 + addressIteTime * 7][4]
          );
          var provinceOrState = document.querySelector(
            "#provinceOrState" + addressIteTime
          );
          imitateKeyInput(
            provinceOrState,
            form5669[6 + addressbase5669 + addressIteTime * 7][4]
          );
          var country = document.querySelector("#country" + addressIteTime);
          imitateKeyInput(
            country,
            form5669[7 + addressbase5669 + addressIteTime * 7][4]
          );
          var postalCode = document.querySelector("#postalCode" + addressIteTime);
          imitateKeyInput(
            postalCode,
            form5669[8 + addressbase5669 + addressIteTime * 7][4]
          );
          addressIteTime++;
        ...
        $$("#next5669").click(function () {
          ...
          $("#texta").val(
            "5669 person " + form5569_counter + " " + form5669[2 + base][4]
          );
          addressIteTime = 0;
          militaryIteTime = 0;
